...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="/media/zzg/GJ_disk01/pretrained_model/laion/CLIP-ViT-H-14-laion2B-s32B-b79K",
                 version="laion2b_s32b_b79k", device="cuda", max_length=77, freeze=True, layer="last"):
        super().__init__()
        assert layer in self.LAYERS
...
class FrozenOpenCLIPImageEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="/media/zzg/GJ_disk01/pretrained_model/laion/CLIP-ViT-H-14-laion2B-s32B-b79K", version="laion2b_s32b_b79k", device="cuda", max_length=77,
...
class FrozenOpenCLIPImageEmbedderV2(AbstractEncoder):
    ...
    def __init__(self, arch="/media/zzg/GJ_disk01/pretrained_model/laion/CLIP-ViT-H-14-laion2B-s32B-b79K", version="laion2b_s32b_b79k", device="cuda",
