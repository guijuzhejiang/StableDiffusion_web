...
# print(response.json())
# show plan
# plan_id = 'P-29A080171D216020RMWZY47Q'
# headers = {
#     'Authorization': f'Bearer {access_token}',
#     'Content-Type': 'application/json',
#     'Accept': 'application/json',
#     'Prefer': 'return=representation',
# }
# response = requests.get(f'https://api-m.sandbox.paypal.com/v1/billing/plans/{plan_id}', headers=headers)
#
# print(response.json())
...
#     'Prefer': 'return=representation',
# }
# data = [{'op': 'replace', 'path': '/payment_preferences/setup_fee_failure_action', 'value': 'CANCEL'}]
# print(ujson.dumps(data))
# response = requests.patch(f'https://api-m.sandbox.paypal.com/v1/billing/plans/{plan_id}', headers=headers, data=ujson.dumps(data))
...
response = requests.get(f'https://api-m.sandbox.paypal.com/v1/billing/subscriptions/I-8PNCEAMW1ASL', headers=headers)
