...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    "sd_model_checkpoint": OptionInfo(None, "Base model", gr.Dropdown,
                                      lambda: {"choices": ['人物写真', '自然风景', '艺术作品']}, refresh=refresh_checkpoints),
...
options_templates.update(options_section(('ui', "User interface"), {
    ...
    "hidden_tabs": OptionInfo(['Train', 'img2img', 'PNG Info', 'Extras', 'Settings', 'Extensions', 'Checkpoint Merger'], "Hidden UI tabs (requires restart)", ui_components.DropdownMulti, lambda: {"choices": [x for x in tab_names]}),
