...
lora_place_dict = {
    ...
    #delete
    11: {'label': '向日葵海',
         'prompt': 'sunflower_background,<lora:Sunflower_v1:0.1>,outdoor,professional nature photography,calm atmosphere,landscape',
         },
    ...
    13: {'label': '沙滩',
         'prompt': 'beach,<lora:Taketomijima:1>,outdoor,professional nature photography,calm atmosphere,landscape',
         },
    14: {'label': '夏威夷热',
         'prompt': 'tropical_tiki_retreat,<lora:tropical_tiki_retreat-10:1>,outdoor,professional nature photography,calm atmosphere,landscape,Exotic,Hawaiian,aloha',
         },
    15: {'label': '秋天的童话',
