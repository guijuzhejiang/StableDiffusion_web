...
lora_hair_color_dict = {
    ...
    2: {'label': '棕色',
        'prompt': '(brown hair:1.3),ultra high resolution,<lora:dyed_pubes-10:1>',
        },
    3: {'label': '紫色',
    ...
    7: {'label': '蓝色',
        'prompt': 'blue hair,ultra high resolution,<lora:dyed_pubes-10:1>',
        },
    8: {'label': '深蓝色',
        'prompt': '(dark blue hair:1.3)',
        },
    9: {'label': '绿色',
         'prompt': '(green hair:1.3), green pubic hair,ultra high resolution,<lora:dyed_pubes-10:1>',
         },
    10: {'label': '橙色',
         'prompt': '(orange hair:1.3),orange pubic hair,ultra high resolution,<lora:dyed_pubes-10:1>',
         },
    11: {'label': '栗色',
