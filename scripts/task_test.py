...
if __name__ == '__main__':
    #
    input_dir = "/home/ray/Desktop/test/ocr/jp/in"
    output_dir = "/home/ray/Desktop/test/ocr/jp/out"

    #
    model_list = [
        '/home/ray/Workspace/project/ocr/github/PaddleOCR/output/rec/JP/japan_distillation_v2.1_finetuning_20211210/infer_latest/Teacher',
        # '/home/ray/Workspace/project/ocr/github/PaddleOCR_GJ/output/rec/japan_mobileV3_small_pretrain_20210903/infer_latest'
                  ]
    model_name = [
        'japan_distillation_v2.1_finetuning_20211210_latest_Teacher',
        # 'db_mv3_finetuning_20211209_det'
                  ]

    ocr = OCRSystem(use_gpu=True, auto_load=False)
    ocr.cfg.det_model_dir = '/home/ray/Workspace/project/ocr/github/PaddleOCR/output/det/JP/db_mv3_finetuning_20211209/infer_epoch100/Student2'
    ocr.cfg.rec_char_dict_path = '/home/ray/Workspace/project/ocr/github/gso_server/lib/ocr/ppocr/utils/dict/japan_dict_guiju_del.txt'
    ...
    for model_index, model in enumerate(model_list):
        for det_limit_side_len in [2560 + 32 * i for i in range(1)]:
