...
lora_haircut_common_dict = {
    'positive_prompt': '(best quality:1.2),(high quality:1.2),(Realism:1.4),masterpiece,raw photo,realistic,character close-up,<lora:more_details:1>,(black shirt:1.3),(simple background:1.3),(cropped arms:1.3)',
