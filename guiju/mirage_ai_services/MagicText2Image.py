...
text2image_style_prompts = {
    ...
    13: {'label': '像素风',
         ...
         'disallow': ['<lora:xl_more_art-full_v1:0.8>','<lora:WowifierXL-V2:0.6>','extremely detailed']},
    14: {'label': '汽车',
         'prompt': 'Automotive advertisement style {prompt} . Sleek, dynamic, professional, commercial, vehicle-focused, high-resolution',
         'disallow': []},
    15: {'label': '时尚杂志',
         'prompt': 'Fashion editorial style {prompt} . High fashion, trendy, stylish, editorial, magazine style, professional',
         'disallow': []},
    16: {'label': '食品摄影',
         'prompt': 'Food photography style {prompt} . Appetizing, professional, culinary, high-resolution, commercial',
         'disallow': []},
    17: {'label': '奢侈品',
         'prompt': 'Luxury product style {prompt} . Elegant, sophisticated, high-end, luxurious, professional',
         'disallow': []},
    18: {'label': '房屋',
         'prompt': 'Real estate photography style {prompt} . Professional, inviting, well-lit, high-resolution, property-focused, commercial',
         'disallow': []},
    19: {'label': '小商品包装',
    ...
    20: {'label': '抽象派',
         ...
         'disallow': ['<lora:xl_more_art-full_v1:0.8>','<lora:WowifierXL-V2:0.6>','extremely detailed']},
    21: {'label': '装饰艺术',
         'prompt': 'Art Deco style {prompt} . geometric shapes, bold colors, luxurious, elegant, decorative, symmetrical, ornate',
         'disallow': []},
    22: {'label': '色块拼图',
    ...
    67: {'label': '黑白电影',
         ...
         'disallow': []},
    68: {'label': '高清',
         'prompt': 'HDR photo of {prompt} . High dynamic range, vivid, rich details, clear shadows and highlights, realistic, intense, enhanced contrast',
         'disallow': []}}
