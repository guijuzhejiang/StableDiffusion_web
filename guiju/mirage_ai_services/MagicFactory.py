...
prompt_character = {
    ...
    15: {'label': 'Hawkeye', 'prompt': '(Hawkeye:1.5)'},
    16: {'label': 'Sentry', 'prompt': '(Sentry:1.5)'},
    17: {'label': 'Magneto', 'prompt': '(Magneto:1.5)'},
    18: {'label': 'Punisher', 'prompt': '(Punisher:1.5)'},
    19: {'label': 'War Machine', 'prompt': '(War Machine:1.5)'},
    20: {'label': 'Carnage', 'prompt': '(Carnage:1.5)'},
    21: {'label': 'Venom', 'prompt': '(Venom:1.5)'},
    22: {'label': 'Scarlet Witch', 'prompt': '(Scarlet Witch:1.5)'},
    23: {'label': 'Ant-Man', 'prompt': '(Ant-Man:1.5)'},
    24: {'label': 'Galactus', 'prompt': '(Galactus:1.5)'},
    25: {'label': 'Moon Knight', 'prompt': '(Moon Knight:1.5)'},
    26: {'label': 'Blade', 'prompt': '(Blade:1.5)'},
    27: {'label': 'Iron Fist', 'prompt': '(Iron Fist:1.5)'},
    28: {'label': 'Star-Lord ', 'prompt': '(Star-Lord :1.5)'},
    29: {'label': 'Harry Potter', 'prompt': '(Harry Potter:1.5)'},
    30: {'label': 'Goku', 'prompt': '(Goku:1.5)'},
    31: {'label': 'Saiyan', 'prompt': '(Saiyan:1.5)'},
    32: {'label': 'Seiya', 'prompt': '(Seiya:1.5)'},
    33: {'label': 'Kamen Rider', 'prompt': '(Kamen Rider:1.5)'},
    34: {'label': 'Sailor Moon', 'prompt': '(Sailor Moon:1.5)'},
    35: {'label': 'Chun-Li', 'prompt': '(Chun-Li:1.5)'}
}
