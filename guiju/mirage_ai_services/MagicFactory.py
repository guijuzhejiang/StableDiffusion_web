...
prompt_male_character = {
    ...
    6: {'label': '滅霸', 'prompt': 'jim lee,Thanos',
        'lora': [{'name': 'jim_lee_offset_right_filesize', 'scale': 0.8, 'trigger': 'jim lee,Thanos'}]},
    ...
    12: {'label': 'Batman', 'prompt': '(Batman:1.5)',
         'female': {
             'label': '女蝙蝠侠Batgirl',
             'prompt': 'cassandra,cape,bodysuit,black bodysuit,belt,belt pouch,black gloves,black pants',
             'lora': [{'name': 'cassandracain-nvwls-v1', 'scale': 0.8}]
         }
         },
    13: {'label': 'Harley Quinn', 'prompt': 'pikkyharleyquinn,midriff',
         'lora': [{'name': 'HarleyQuinnV2', 'scale': 0.9}]},
    ...
    25: {'label': '妙语Punchline', 'prompt': 'CARTOON_DC_punchline_ownwaifu',
         'lora': [{'name': 'CARTOON_DC_punchline_ownwaifu-15', 'scale': 0.7}]},
    26: {'label': '女巫', 'prompt': 'enchantress,superhero suit',
         'lora': [{'name': 'enchantress-10IJ2v8', 'scale': 0.7}]},
    ...
    33: {'label': '白戰士(White Power Ranger)',
         'prompt': 'White_Ranger,solo,black breastplate,detailed armor,superhero suit',
...
prompt_costume = {
    0: {'label': '校服', 'prompt': '(school uniform:1.3)'},
     ...
     4: {'label': '军服', 'prompt': '(garreg mach monastery uniform:1.3)'},
     5: {'label': '晚礼服', 'prompt': '(evening gown:1.3)'},
     ...
     19: {'label': '短运动服', 'prompt': '(exercise clothing:1.3)'},
     20: {'label': '剪裁牛仔', 'prompt': '(cropped jacket :1.3)'},
     21: {'label': '睡衣', 'prompt': '(pajamas:1.3)'},
     22: {'label': '和服', 'prompt': '(japanese yukata:1.3)'},
     ...
     34: {'label': '篮球服', 'prompt': '(basketball uniform:1.3)'},
     35: {'label': '体操服', 'prompt': '(athletic leotard:1.3)'},
     36: {'label': '兔女郎', 'prompt': '(playboy bunny leotard:1.3)'},
     37: {'label': '高领毛衣', 'prompt': '(turtleneck sweater:1.3)'},
     38: {'label': '旗袍', 'prompt': '(cheongsam:1.3)'},
     39: {'label': '宇航服', 'prompt': '(space suit:1.3)'},
     40: {'label': '紧身乳胶衣', 'prompt': '(latex_bodysuit:1.3)'},
     41: {'label': '赛车服', 'prompt': '(racing suit:1.3)'},
     42: {'label': '医生白大挂', 'prompt': '(lab_coat:1.3)'},
     43: {'label': '兜帽斗篷', 'prompt': '(cape hood:1.3)'},
     44: {'label': '风衣', 'prompt': '(overcoat:1.3)'},
     45: {'label': '汉服', 'prompt': '(hanfu:1.3)'},
     46: {'label': '战斗服', 'prompt': '(combat suit:1.3)'},
     47: {'label': '皮夹克', 'prompt': '(leather jacket:1.3)'},
     48: {'label': '浴袍', 'prompt': '(bathrobe:1.3)'},
     49: {'label': '盔甲', 'prompt': '(armor:1.3)'},
     50: {'label': '动力甲', 'prompt': '(power armor:1.3)'},
     51: {'label': '外骨骼', 'prompt': '(exoskeleton:1.3)'},
     52: {'label': '外骨骼机甲', 'prompt': '(Exoskeleton Mecha:1.3)'},
     53: {'label': '道袍', 'prompt': '(Taoist robe:1.3)'},
     54: {'label': '军官大衣', 'prompt': '(Army overcoat:1.3)'},
    ...
    def __call__(self, *args, **kwargs):
        ...
        #     return {'success': False, 'result': 'backend.magic-factory.error.multi-face'}
            ...
            if _character_enable:
                character_dict = prompt_male_character[_character]['female'] if 'female' in prompt_male_character[
                    _character].keys() and _gender == 0 else prompt_male_character[_character]
