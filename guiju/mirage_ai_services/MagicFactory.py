...
prompt_character = {
    ...
    2: {'label': '护士', 'prompt': '(nurse:1.5)'},
    3: {'label': '空姐', 'prompt': '(stewardess:1.5)'},
    4: {'label': '学生', 'prompt': '(school uniform:1.5)'},
    5: {'label': '牧师', 'prompt': '(police:1.5)'},
}
...
prompt_scene = {
    ...
    3: {'label': '机器改造人',
        'prompt': '(robot:1.5),surreal'},
    4: {'label': '赛博机器人',
        'prompt': '(cyberpunk:1.5),mechanical,surreal'},
    5: {'label': '竹林',
        'prompt': '(bamboo forest:1.5)'},
    6: {'label': '健身房',
