...
prompt_character = {
    ...
    2: {'label': 'Dracula', 'prompt': '(Dracula:1.3)'},
    3: {'label': 'Spiderman', 'prompt': '(Spiderman:1.3)'},
    4: {'label': 'Superman', 'prompt': '(Superman:1.3)'},
    5: {'label': 'Iron man', 'prompt': '(Iron man:1.3)'},
    6: {'label': 'Thanos', 'prompt': '(Thanos:1.3)'},
    7: {'label': 'Hulk', 'prompt': '(Hulk:1.3)'},
    8: {'label': 'Red Hulk', 'prompt': '(Red Hulk:1.3)'},
    9: {'label': 'Deadpool', 'prompt': '(Deadpool:1.3)'},
    10: {'label': 'Thor', 'prompt': '(Thor:1.3)'},
    11: {'label': 'Black Panther', 'prompt': '(Black Panther:1.3)'},
    12: {'label': 'Captain America', 'prompt': '(Captain America:1.3)'},
    13: {'label': 'Green Arrow', 'prompt': '(Green Arrow:1.3)'},
    14: {'label': 'Batman', 'prompt': '(Batman:1.3)'},
    15: {'label': 'Joker', 'prompt': '(Joker:1.3)'},
    16: {'label': 'Harley Quinn', 'prompt': '(Harley Quinn:1.3)'},
    17: {'label': 'Naruto', 'prompt': '(Naruto:1.3)'},
    18: {'label': 'Sasuke', 'prompt': '(Sasuke:1.3)'},
    19: {'label': 'Black Widow', 'prompt': '(Black Widow:1.3)'},
    20: {'label': 'Hawkeye', 'prompt': '(Hawkeye:1.3)'},
    21: {'label': 'Sentry', 'prompt': '(Sentry:1.3)'},
    22: {'label': 'Magneto', 'prompt': '(Magneto:1.3)'},
    23: {'label': 'Ghost Rider', 'prompt': '(Ghost Rider:1.3)'},
    24: {'label': 'Punisher', 'prompt': '(Punisher:1.3)'},
    25: {'label': 'War Machine', 'prompt': '(War Machine:1.3)'},
    26: {'label': 'Daredevil', 'prompt': '(Daredevil:1.3)'},
    27: {'label': 'Winter Soldier', 'prompt': '(Winter Soldier:1.3)'},
    28: {'label': 'Carnage', 'prompt': '(Carnage:1.3)'},
    29: {'label': 'Venom', 'prompt': '(Venom:1.3)'},
    30: {'label': 'Scarlet Witch', 'prompt': '(Scarlet Witch:1.3)'},
    31: {'label': 'Ant-Man', 'prompt': '(Ant-Man:1.3)'},
    32: {'label': 'Galactus', 'prompt': '(Galactus:1.3)'},
    33: {'label': 'Moon Knight', 'prompt': '(Moon Knight:1.3)'},
    34: {'label': 'Juggernaut', 'prompt': '(Juggernaut:1.3)'},
    35: {'label': 'Blade', 'prompt': '(Blade:1.3)'},
    36: {'label': 'Iron Fist', 'prompt': '(Iron Fist:1.3)'},
    37: {'label': 'Mystique', 'prompt': '(Mystique:1.3)'},
    38: {'label': 'Doctor Doom', 'prompt': '(Doctor Doom:1.3)'},
    39: {'label': 'Star-Lord ', 'prompt': '(Star-Lord :1.3)'},
    40: {'label': 'Harry Potter', 'prompt': '(Harry Potter:1.3)'},
    41: {'label': 'Mario', 'prompt': '(Mario:1.3)'},
    42: {'label': 'Goku', 'prompt': '(Goku:1.3)'},
    43: {'label': 'Vegeta', 'prompt': '(Vegeta:1.3)'},
    44: {'label': 'Saiyan', 'prompt': '(Saiyan:1.3)'},
    45: {'label': 'Seiya', 'prompt': '(Seiya:1.3)'},
    46: {'label': 'Kamen Rider', 'prompt': '(Kamen Rider:1.3)'},
    47: {'label': 'Sailor Moon', 'prompt': '(Sailor Moon:1.3)'},
    48: {'label': 'Monkey D Luffy', 'prompt': '(Monkey D Luffy:1.3)'},
    49: {'label': 'Chun-Li', 'prompt': '(Chun-Li:1.3)'}
}
