...
prompt_character = {
    ...
    7: {'label': 'Deadpool', 'prompt': '(Deadpool:1.3)'},
    8: {'label': 'Thor', 'prompt': '(Thor:1.3)'},
    9: {'label': 'Black Panther', 'prompt': '(Black Panther:1.3)'},
    10: {'label': 'Captain America', 'prompt': '(Captain America:1.3)'},
    11: {'label': 'Green Arrow', 'prompt': '(Green Arrow:1.3)'},
    12: {'label': 'Batman', 'prompt': '(Batman:1.3)'},
    13: {'label': 'Harley Quinn', 'prompt': '(Harley Quinn:1.3)'},
    14: {'label': 'Black Widow', 'prompt': '(Black Widow:1.3)'},
    15: {'label': 'Hawkeye', 'prompt': '(Hawkeye:1.3)'},
    16: {'label': 'Sentry', 'prompt': '(Sentry:1.3)'},
    17: {'label': 'Magneto', 'prompt': '(Magneto:1.3)'},
    18: {'label': 'Punisher', 'prompt': '(Punisher:1.3)'},
    19: {'label': 'War Machine', 'prompt': '(War Machine:1.3)'},
    20: {'label': 'Carnage', 'prompt': '(Carnage:1.3)'},
    21: {'label': 'Venom', 'prompt': '(Venom:1.3)'},
    22: {'label': 'Scarlet Witch', 'prompt': '(Scarlet Witch:1.3)'},
    23: {'label': 'Ant-Man', 'prompt': '(Ant-Man:1.3)'},
    24: {'label': 'Galactus', 'prompt': '(Galactus:1.3)'},
    25: {'label': 'Moon Knight', 'prompt': '(Moon Knight:1.3)'},
    26: {'label': 'Blade', 'prompt': '(Blade:1.3)'},
