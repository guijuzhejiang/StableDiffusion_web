...
function selected_gallery_button() {
    var allCurrentButtons = gradioApp().querySelectorAll('div[id$=_gallery].gradio-gallery .thumbnail-item.thumbnail-small.selected');
...
function submit() {
    ...
    requestProgress(id, gradioApp().getElementById('gallery_container'), gradioApp().getElementById('txt2img_gallery'), function () {
